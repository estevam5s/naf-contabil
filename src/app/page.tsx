    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Contact Info */}
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-2">
              <Phone className="h-5 w-5 text-amber-600" />
              <span className="font-medium text-amber-800 dark:text-amber-200">Contato: (48) 98461-4449</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Sistema Unificado</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Analytics Avançado</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Eficiência Total</h3>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      {/* Contact Section */}
      <section className="py-20 bg-blue-600 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Entre em Contato
            ...
            {contactInfo.map((contact, index) => (
              <Card key={index} className="text-center">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg mb-2 dark:text-white">{contact.label}</CardTitle>
