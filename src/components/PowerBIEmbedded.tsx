            ...
            <CardContent className="text-yellow-800">
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-yellow-200">
                  ...
                  <p className="text-sm">Configure o Power BI para atualizar os dados automaticamente através da API: <code className="bg-gray-100 px-2 py-1 rounded">/api/reports/powerbi</code></p>
                </div>
              </div>
            </CardContent>
          </Card>
